...
<div class="widget"> 
  ...
  <div style="text-align: center;"><a href="https://circuits4you.com/2019/03/22/esp8266-weather-station-arduino/" style="align:center">circuits4you.com</a></div>
  <div class="lower">    
    <ul class="infos">
      <li class="info temp">
      ...
      <li class="info wind">
        <h2 class="title">LUX</h2>
        <span class='update' id="lux">0 lx</span>
      </li>
...
function drawClock(){
    ...
    //Get Humidity Temperature and other Data
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() {
      if (this.readyState == 4 && this.status == 200) {
      var txt = this.responseText;
      var obj = JSON.parse(txt); //Ref: https://www.w3schools.com/js/js_json_parse.asp
        document.getElementById("lux").innerHTML = Math.round(obj.Lux) + " lx";
        ...
        document.getElementById("pressure").innerHTML = Math.round(obj.Pressure) + " mb";
      }  
    };
